...
<table class="container" align="center" border="0" cellpadding="0" cellspacing="0" width="600">
    <tbody>
    <tr bgcolor="4a148c"><td height="15"></td></tr>
                                ...
                                <td align="center">
                                    <table class="date" border="0" cellpadding="0" cellspacing="0">
                                        <tbody><tr>
                                            ...
                                            <td style="color: #FFFFFF; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                                <singleline>
                                                    <?php 
    ...
    <tr bgcolor="4a148c"><td height="10"></td></tr>
            ...
            <tbody><tr>
                <td>
                    <table class="logo" align="center" border="0" cellpadding="0" cellspacing="0">
                        <tbody><!-- <tr>
                            <td align="center">
                                <img  style="display: block;" src="" alt="logo" width="200">
                            </td>
                        </tr> -->
                        </tbody></table>
                    ...
                    <table class="mainContent" align="center" border="0" cellpadding="0" cellspacing="0" width="528">
                        ...
                        <tr>
                            <td> 
                                ...
                                <table class="section-item" align="left" border="0" cellpadding="0" cellspacing="0" width="">
                         <tbody>
                            <tr><td height="10"></td></tr>
                            <tr><td height="10"></td></tr>
                            <tr>
                                <td  style="color: #000; font-size: 16px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;"> Dear 
                                    <?php echo ucfirst($NAME);?> 
                                </td>
                            </tr>
                            <tr>
                                <td  style="color: #000; line-height: 25px; font-size: 12px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                    <br>
                                    Welcome to <?=PROJECT_NAME?>. A wonderful place where you collect your all certificates.
                                </td>
                            </tr>
                            <tr>
                                <td style="color: #000; line-height: 25px; font-size: 12px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
...
<table class="container" border="0" cellpadding="0" cellspacing="0" width="600">
    ...
    <tr bgcolor="4a148c"><td height="15"></td></tr>
    <tr bgcolor="4a148c">
        <td  style="color: #FFFFFF; font-size: 10px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" align="center">
            Copyright © <?php echo date('Y'); ?> <?=PROJECT_NAME?> - All Rights Reserved.
        </td>
    </tr>

    <tr> 
        <td bgcolor="4a148c" height="14"></td>
    </tr>
    </tbody></table>
<!-- end footer-->
</td>
